...
INSERT INTO `epstore`.`User` (`user_id`, `email`, `name`, `surname`, `password_digest`, `role_id`, `user_active`, `user_activation_token`, `user_activation_token_created_at`, `user_created_at`) VALUES ('3', 'stranka@ep.si', 'Stranka', 'Ena', '$2y$10$iXADxNZSSTiyo5S3UfZ4L.qjsd/V57jRFqWnMPOzM7RT1FkCVRRTm', '3', '1', 'AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA', '2016-01-01 00:00', '2016-01-01 00:00');
